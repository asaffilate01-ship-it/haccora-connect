  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        answer:
          "The customer normally decides why and how its workforce data is used and must provide clear privacy information. Haccora (a trading name of iTechLounge) processes customer data under the signed terms and data-processing agreement. Customers should document their lawful basis and complete a data-protection impact assessment where the processing is likely to create high risk.",
      },
      {
