...
| Migration lineage           | Passed for 55 migrations, 236 policies and 85 function definitions |
| Secret-pattern scan         | Passed across every tracked source file                            |
| Web TypeScript              | Passed                                                             |
| Security regression suite   | 143 of 143 tests passed                                            |
