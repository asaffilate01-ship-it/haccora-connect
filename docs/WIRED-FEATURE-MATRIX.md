...
| Equipment QR and maintenance    | Printable QR identity, protected scan, asset details and immutable event history | Two seeded assets and history records       | Printed-label durability and device-camera test    |
