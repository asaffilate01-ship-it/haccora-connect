...
const required = [
  ...
  "docs/DOKUVERA-EVIDENCE-BRIDGE.md",
  ...
  "supabase/functions/dokuvera-admin/index.ts",
  "supabase/functions/dokuvera-webhook/index.ts",
  "supabase/functions/_shared/dokuvera-access.ts",
  "supabase/functions/operations-health/index.ts",
  "supabase/migrations/20260828150000_dokuvera_evidence_bridge.sql",
  ...
  "tests/lovable-payments-hardening.test.mjs",
