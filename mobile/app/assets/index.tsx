...
const styles = StyleSheet.create({
  ...
  intro: { color: "#666", fontSize: 11, lineHeight: 16, marginTop: 2 },
  scan: { backgroundColor: "#c8102e", borderRadius: 9, paddingHorizontal: 13, paddingVertical: 10 },
  scanText: { color: "#fff", fontSize: 11, fontWeight: "900" },
  search: {
    backgroundColor: "#fff",
    borderColor: "#ddd",
    borderRadius: 10,
  ...
  code: { color: "#555", fontSize: 9, fontWeight: "800", marginTop: 2, textTransform: "uppercase" },
  meta: { color: "#777", fontSize: 9, marginTop: 4 },
  status: { color: "#176b3a", fontSize: 9, fontWeight: "900" },
  ...
  emptyText: { color: "#777", fontSize: 11, marginTop: 4, textAlign: "center" },
});
